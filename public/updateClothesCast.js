const updateClothesCast = (data) => { 
    ...
    if (today.precipprob <= 50 && today.precipprob > 20) { // likely rain
        ...
        clothingItems[2].innerHTML = `<img src="../src/icons/clothes/boots.svg" class="svg-icon" alt=""></img>`;
    } else {
    ...
    if (today.snow || today.precip > 2) {
        ...
        clothingItems[3].innerHTML = `<img src="../src/icons/clothes/sandals.svg" class="svg-icon" alt=""></img>`
    } else if (today.feelslikeMax > 50 && today.feelslikeMax < 100) {
        clothingItems[2].innerHTML = `<img src="../src/icons/clothes/sneakers.svg" class="svg-icon" alt=""></img>`;
    } else {
        clothingItems[2].innerHTML = `<img src="../src/icons/clothes/sneakers.svg" class="svg-icon" alt=""></img>`; 
    }
    ...
    if (today.tempmin < 70 && today.tempmin > 55) {
        clothingItems[1].innerHTML = `<img src="../src/icons/clothes/pants.svg" class="svg-icon" alt=""></img>`;
    } else if (today.tempmin <= 55) {
        clothingItems[1].innerHTML = `<img src="../src/icons/clothes/jeans.svg" class="svg-icon" alt=""></img>`;
    } else {
        clothingItems[1].innerHTML = `<img src="../src/icons/clothes/shorts.svg" class="svg-icon" alt=""></img>`;
    }
