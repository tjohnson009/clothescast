...
class UI {
  ...
  fillSecondaryDatapoints(data) {
    ...
    // UV Index
    this.UVindex.innerHTML = `<img src="../public/icons/weather/line/all/uv-index-${data.currentConditions.uvindex}.svg" class="svg-icon" alt=""></img>`; 
    ...
    if (moonPhase === 0) {
      // New moon
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-new.svg" class="svg-icon" alt="New Moon"></img>`;
    } else if (moonPhase > 0 && moonPhase < 0.25) {
      // Waxing crescent
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-waxing-crescent.svg" class="svg-icon" alt="Waxing Crescent"></img>`;
    } else if (moonPhase === 0.25) {
      // First quarter
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-first-quarter.svg" class="svg-icon" alt="First Quarter"></img>`;
    } else if (moonPhase > 0.25 && moonPhase < 0.5) {
      // Waxing gibbous
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-waxing-gibbous.svg" class="svg-icon" alt="Waxing Gibbous"></img>`;
    } else if (moonPhase === 0.5) {
      // Full moon
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-full.svg" class="svg-icon" alt="Full Moon"></img>`;
    } else if (moonPhase > 0.5 && moonPhase < 0.75) {
      // Waning gibbous
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-waning-gibbous.svg" class="svg-icon" alt="Waning Gibbous"></img>`;
    } else if (moonPhase === 0.75) {
      // Last quarter
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-last-quarter.svg" class="svg-icon" alt="Last Quarter"></img>`;
    } else if (moonPhase > 0.75 && moonPhase < 1) {
      // Waning crescent
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-waning-crescent.svg" class="svg-icon" alt="Waning Crescent"></img>`;
    } else {
      // Default full moon
      this.moonDiv.innerHTML = `<img src="../public/icons/weather/line/all/moon-full.svg" class="svg-icon" alt="Default Full Moon"></img>`;
    }
  ...
  updateTemperatureIcon(data) {
    ...
    let imgHTML = `<img id="temp-icon" src="../public/icons/weather/line/all/${data.currentConditions.icon}.svg" class="svg-icon" alt=""></img>`; 
      // console.log(this.tempIcon.src); 
      //nighttime
    // } else {
      // this.tempIcon.src = `../public/icons/weather/line/all/clear-day.svg`; 
    // }
